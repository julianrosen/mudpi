...
const struct flag_type room_flags[] =
{
    ...
    {   "mage_guild",		ROOM_MAGE_GUILD, 	TRUE	},
    {   "cleric_guild",		ROOM_CLERIC_GUILD, 	TRUE	},
    {   "thief_guild",		ROOM_THIEF_GUILD, 	TRUE	},
    {   "warrior_guild",	ROOM_WARRIOR_GUILD, 	TRUE	},
    {   "paladin_guild",	ROOM_PALADIN_GUILD, 	TRUE	},
    {   "avenger_guild",	ROOM_AVENGER_GUILD, 	TRUE	},
    {   "nightblade_guild",	ROOM_NIGHTBLADE_GUILD, 	TRUE	},
...
const struct flag_type extra_flags[] =
{
    ...
    {   "anti-avenger",         ITEM_ANTI_AVENGER,      TRUE    },
    {   "anti-nightblade",      ITEM_ANTI_NIGHTBLADE,   TRUE    },
...
/* fixed part flags coded by Rindar (Ron Cole) */
...
const struct flag_type raffect_type[] =
{
     {  "none",         0,              FALSE},
     {  "damage",       RAFF_DAMAGE,    TRUE },
     {  "",             0,              0    }
};

const struct flag_type rafdam_type[] = 
{
     {  "none",         DAM_NONE,       TRUE },
     {  "bash",         DAM_BASH,       TRUE },
...
const struct flag_type clan_join_flags[] =
{
    ...
    {   "anti-paladin",         CLAN_ANTI_PALADIN,      TRUE    },
    {   "anti-avenger",         CLAN_ANTI_AVENGER,      TRUE    },
    {   "anti-nightblade",      CLAN_ANTI_NIGHTBLADE,   TRUE    },
