...
{ "General",  	"General discussion - OOC",      0,     2,     "all", DEF_INCLUDE,14, NULL, FALSE },
{ "Ideas",	"Suggestion for improvement",	 0,     2,     "all",  DEF_NORMAL, 10, NULL, FALSE }, 
{ "Announce", 	"Announcements from Immortals",  0,     L_IMM, "all", DEF_NORMAL, 40, NULL, FALSE },
{ "Bugs",	"Typos, bugs, errors",		 0,     1,     "imm", DEF_NORMAL, 40, NULL, FALSE },
{ "Personal", 	"Personal messages",		 0,     1,     "all", DEF_EXCLUDE,21, NULL, FALSE },
{ "Roleplay",  	"General discussion - IC",      0,     2,     "all", DEF_NORMAL,14, NULL, FALSE },
{ "Quest",  	"Quest announcements",      0,     L_IMM,     "all", DEF_INCLUDE,21, NULL, FALSE },
{ "Clan",  	"Clan discussions",      0,     5,     "all", DEF_NORMAL,14, NULL, FALSE },
{ "Immortal",  	"Immortal discussions",      L_IMM,     L_IMM,     "imm", DEF_INCLUDE,21, NULL, FALSE }
...
static void do_nwrite (CHAR_DATA *ch, char *argument)
{
	...
	if (!IS_SET(ch->act,PLR_AFK)) SET_BIT(ch->act,PLR_AFK);
