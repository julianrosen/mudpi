...
#define CLASS_OLD_MAGE		0
#define CLASS_CLERIC		1
#define CLASS_THIEF		2
#define CLASS_WARRIOR		3
#define CLASS_PALADIN		4
#define CLASS_AVENGER		5
#define CLASS_NIGHTBLADE	6
#define CLASS_NEW_MAGE		7
...
#include "isplay"
#include <signal.h>
/* global unistd.h makes comm.c barf */
/*
#include <unistd.h>
*/
#include <stdarg.h>
...
struct race_type
{
    ...
    bool    can_choose;		/* can be chosen on creation */
...
#define ITEM_ANTI_PALADIN	(U)
#define ITEM_ANTI_AVENGER	(V)
#define ITEM_ANTI_NIGHTBLADE	(W)
...
#define ROOM_FAST_REGEN		(E)
#define ROOM_SLOW_REGEN		(F)
...
#define ROOM_MARK		(V)
#define ROOM_MAGE_GUILD		(W)
#define ROOM_CLERIC_GUILD	(X)
#define ROOM_THIEF_GUILD	(Y)
#define ROOM_WARRIOR_GUILD	(Z)
#define ROOM_PALADIN_GUILD	(aa)
#define ROOM_AVENGER_GUILD	(bb)
#define ROOM_NIGHTBLADE_GUILD   (cc)
/*
 * Directions.
 * Used in #ROOMS.
 */
...
struct	reset_data
{
    ...
    sh_int		arg2;
    sh_int		arg3;
    sh_int		not_save; /* to save... or not to save */
};
...
void  send_wiz          args( ( int level, char *message) );
...
/* room progs */
void 	rprog_act_trigger	args ( ( char *buf, ROOM_INDEX_DATA *room, 
