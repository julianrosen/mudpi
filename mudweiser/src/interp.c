...
const	struct	cmd_type	cmd_table	[] =
{
 ...
 /* { "at",             do_at,          POS_DEAD,       L6,  LOG_NORMAL, 1 }, */
    ...
    { "byu",		do_buy,		POS_RESTING,	 0,  LOG_NORMAL, 0 },
 ...
 /* { "goto",           do_goto,        POS_DEAD,       L8,  LOG_NORMAL, 1 }, */
  ...
  /*  { "last",		do_last,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "lastimm",	do_lastimm,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
  */  { "messages",	do_messages,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "tq",		do_tq,		POS_RESTING,	 0,  LOG_NORMAL, 1 },
...
/*    { "show",		do_show,	POS_DEAD,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "lsit",		do_list,	POS_RESTING,	 0,  LOG_NORMAL, 0 },
...
/***/
     ...
     * Clan commands!
     */
    { "promote", 	do_promote,	POS_RESTING,	10, LOG_NORMAL, 1 },
/*  { "clan",		do_clan,	POS_DEAD,	 ML,  LOG_NORMAL, 1 }, */
    ...
    { "accept",		do_accept,	POS_RESTING,	0,  LOG_NORMAL, 1 },
    { "decline",		do_decline,	POS_RESTING,	0,  LOG_NORMAL, 1 },
    { "offer",		do_offer,	POS_RESTING,	0,  LOG_NORMAL, 1 },
    { "clantalk",		do_clantalk, POS_SLEEPING, 	L1,  LOG_ALWAYS, 1 },
    { "resign",		do_resign,	POS_SLEEPING,	0,  LOG_ALWAYS,1 },
    { "demote",		do_demote,	POS_SLEEPING,	0,  LOG_ALWAYS,1 },
     ...
     */
     ...
     { "clan",		do_clan,	POS_DEAD,	ML,  LOG_ALWAYS, 0 }, 
     { "dump",		do_dump,	POS_DEAD,	ML,  LOG_ALWAYS, 0 },
     { "edprog",	do_setprog,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },
     ...
     { "ededit",	do_setedit,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
     { "sinfo",	  	do_sendinfo,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
     { "deny",		do_deny,	POS_DEAD,	L2,  LOG_ALWAYS, 1 },
     { "hotboot", 	do_copyover,	POS_DEAD,	L2,  LOG_ALWAYS, 1 },
     { "set",		do_set,		POS_DEAD,	L2,  LOG_ALWAYS, 1 },
     { "wizlock",	do_wizlock,	POS_DEAD,	L2,  LOG_ALWAYS, 1 },
     { "alist",		do_alist,	POS_DEAD,    L3,  LOG_NORMAL, 1 },
     { "asave",         do_asave,	POS_DEAD,    L3,  LOG_NORMAL, 1 },
     { "edit",		do_olc,	POS_DEAD,    L3,  LOG_NORMAL, 1 },
     { "mpstat",         do_mpstat,      POS_DEAD,       L3,  LOG_NORMAL, 1 },  
     { "raffect",       do_raffect,     POS_DEAD,       L3,  LOG_ALWAYS, 1 },
     { "resets",		do_resets,	POS_DEAD,    L3,  LOG_NORMAL, 1 },
     { "return",         do_return,      POS_DEAD,       L3,  LOG_NORMAL, 1 },
     { "switch",		do_switch,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },
     { "wiznet",	      do_wiznet,	POS_DEAD,	L3,  LOG_NORMAL, 1 },
     { "allow",		do_allow,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
     { "ban",		do_ban,		POS_DEAD,	L4,  LOG_ALWAYS, 1 },
     { "clone",		do_clone,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
     { "cut",           do_new_discon,  POS_DEAD,       L4,  LOG_ALWAYS, 1 },   { "load", do_load, POS_DEAD, L4, LOG_ALWAYS, 1 },
     { "log",		do_log,		POS_DEAD,	L4,  LOG_ALWAYS, 1 },
     { "newlock",	do_newlock,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
     { "pardon",		do_pardon,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
     { "repop",		do_repop,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
     { "restore", 	do_restore,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
     { "disconnect",	do_disconnect,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
     { "freeze",		do_freeze,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
     { "gecho",		do_echo,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
     { "objcheck",		do_objcheck,	POS_DEAD,	L5,  LOG_NORMAL, 1 },      
     ...
     { "sockets",        do_sockets,	POS_DEAD,       L5,  LOG_NORMAL, 1 }, 
     { "stat",		do_stat,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
     { "string",		do_string,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
     { "at",             do_at,          POS_DEAD,       L6,  LOG_NORMAL, 1 }, 
     { "echo",		do_recho,	POS_DEAD,	L6,  LOG_ALWAYS, 1 },
     { "force",		do_force,	POS_DEAD,	L6,  LOG_ALWAYS, 1 },   
     { "hidden",	do_hidden,	POS_DEAD,	L6,  LOG_NORMAL, 1 }, 
     { "nochannels",	do_nochannels,	POS_DEAD,	L6,  LOG_ALWAYS, 1 },
     ...
     { "memory",		do_memory,	POS_DEAD,	L6,  LOG_NORMAL, 1 },
     { "murde",		do_murde,	POS_FIGHTING,	L6,  LOG_NORMAL, 0 },
     { "murder",		do_murder,	POS_FIGHTING,	L6,  LOG_ALWAYS, 1 },
     { "mwhere",		do_mwhere,	POS_DEAD,	L6,  LOG_NORMAL, 1 },
     ...
     { "wizinvis",	do_invis,	POS_DEAD,	L6,  LOG_NORMAL, 1 }, 
     { "beacon",         do_beacon,      POS_DEAD,       L7,  LOG_NORMAL, 1 },
     ...
     { "holylight",	do_holylight,	POS_DEAD,	HE,  LOG_NORMAL, 1 }, 
     { "imotd",          do_imotd,       POS_DEAD,       HE,  LOG_NORMAL, 1 },
     { "wizhelp",	do_wizhelp,	POS_DEAD,	HE,  LOG_NORMAL, 1 },  
     { "rlist",		do_rlist,	POS_DEAD,	90,  LOG_NORMAL, 0 },    
     ...
     { "reboo",		do_reboo,	POS_DEAD,	ML,  LOG_NORMAL, 0 },
     { "reboot",		do_reboot,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },
     { "ededit",	do_setedit,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },
     { "edprog",	do_setprog,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },
     { "shutdow",	do_shutdow,	POS_DEAD,	ML,  LOG_NORMAL, 0 },     
     { "shutdown",	do_shutdown,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },
     { "trust",		do_trust,	POS_DEAD,	ML,  LOG_ALWAYS, 1 },
     { "deny",		do_deny,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
     { "hotboot", 	do_copyover,	POS_DEAD,	L1,  LOG_ALWAYS, 1 },
     ...
     { "asave",         do_asave,	POS_DEAD,    93,  LOG_NORMAL, 1 },
     { "beacon",         do_beacon,      POS_DEAD,       L7,  LOG_NORMAL, 1 },
     { "clone",		do_clone,	POS_DEAD,	L7,  LOG_ALWAYS, 1 },
     { "echo",		do_recho,	POS_DEAD,	L7,  LOG_ALWAYS, 1 },
     { "edit",		do_olc,	POS_DEAD,    93,  LOG_NORMAL, 1 },
     { "force",		do_force,	POS_DEAD,	L7,  LOG_ALWAYS, 1 },
     { "gecho",		do_echo,	POS_DEAD,	L7,  LOG_ALWAYS, 1 },
     { "load",		do_load,	POS_DEAD,	L7,  LOG_ALWAYS, 1 },
     { "mpstat",         do_mpstat,      POS_DEAD,       L7,  LOG_NORMAL, 1 }, 
     { "pecho",		do_pecho,	POS_DEAD,	L7,  LOG_ALWAYS, 1 },
     { "purge",		do_purge,	POS_DEAD,	L7,  LOG_ALWAYS, 1 },
     { "teleport",	do_transfer,POS_DEAD,	L7,  LOG_ALWAYS, 1 },	
     { "transfer",	do_transfer,POS_DEAD,	L7,  LOG_ALWAYS, 1 },
     { "resets",		do_resets,	POS_DEAD,    93,  LOG_NORMAL, 1 },
     ...
     { "raffect",       do_raffect,     POS_DEAD,       IM,  LOG_ALWAYS, 1 },
     { "stat",		do_stat,	POS_DEAD,	IM,  LOG_ALWAYS, 1 },
     { "wizinvis",	do_invis,	POS_DEAD,	IM,  LOG_NORMAL, 1 },
     { "hidden",	do_hidden,	POS_DEAD,	IM,  LOG_NORMAL, 1 }, 
     { "goto",           do_goto,        POS_DEAD,       L8,  LOG_NORMAL, 1 },  
     { "poofin",		do_bamfin,	POS_DEAD,	L8,  LOG_NORMAL, 1 },
     { "poofout",	do_bamfout,	POS_DEAD,	L8,  LOG_NORMAL, 1 },
     { "repop",		do_repop,	POS_DEAD,	L8,  LOG_ALWAYS, 1 },
     { "immtalk",	do_immtalk,	POS_DEAD,	HE,  LOG_NORMAL, 1 },
     { "imotd",          do_imotd,       POS_DEAD,       HE,  LOG_NORMAL, 1 },
     { ",",		do_immtalk,	POS_DEAD,	HE,  LOG_NORMAL, 0 },
     { "wizhelp",	do_wizhelp,	POS_DEAD,	HE,  LOG_NORMAL, 1 },  
     { "alist",		do_alist,	POS_DEAD,    90,  LOG_NORMAL, 1 },
     { "rlist",		do_rlist,	POS_DEAD,	90,  LOG_NORMAL, 0 }, 
...
void interpret( CHAR_DATA *ch, char *argument )
{
    ...
    if (IS_SET(ch->act,PLR_AFK) && !IS_NPC(ch) )
      {
	 ...
	 if (str_prefix(command,"afk"))
	   {
	      sprintf(buff,"`RYou're still AFK!`w - %d message%s waiting.\n\r",
		      ch->pcdata->messages,
		      ((ch->pcdata->messages>1)||(ch->pcdata->messages<1)) ?
		      "s" : "");
	...
	case 1: 
{
	send_to_char( "I'm sure it's a great command, but you can't use it.\n\r", ch );
	break;
}
	case 2: 
{
	send_to_char( "Nice command.  Did you just make it up?\n\r", ch );
	break;
}
	case 3: 
{
	send_to_char( "Did you really think that command would work?\n\r", ch );
	break;
}
	case 4: 
{
	send_to_char( "Try that command again, only this time do it right.\n\r", ch );
	break;
}
	case 5: 
{
	send_to_char( "Was that command intended to do something?\n\r", ch );
	break;
}
	default: 
{
