...
void reset_room( ROOM_INDEX_DATA *pRoom )
{
	...
	char buf[MAX_STRING_LENGTH];
        ...
        case 'P':
			...
			sprintf(buf, "Bad pet vnum %d in room %d, fix before rebooting.", pReset->arg1, pRoom->vnum);
			send_wiz(93, buf);
                continue;
            }
			...
			sprintf(buf, "Bad mob vnum %d in room %d, fix before rebooting.", pReset->arg3, pRoom->vnum);
			send_wiz(93, buf);
                continue;
            }
