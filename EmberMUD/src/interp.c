...
const struct cmd_type cmd_table[] = {
    ...
    /* { "command_name", command_function, MIN_POSITION, immortal?, 
    log, show, use_wait_queue }*/
...
/* Enter a portal */
    ...
    {"order", do_order, POS_RESTING, 0, LOG_ALWAYS, 1, TRUE},
    {CFG_OOC_NAME, do_ooc, MIN_POS_OOC, 0, LOG_NORMAL, 1, FALSE},
    {"practice", do_practice, POS_SLEEPING, 0, LOG_NORMAL, 1, TRUE},
    ...
    {"tell", do_tell, MIN_POS_TELL, 0, LOG_NORMAL, 1, TRUE},
    ...
    {"track", do_track, POS_RESTING, 0, LOG_NORMAL, 1, TRUE},
    ...
    {"withdraw", do_withdraw, POS_STANDING, 0, LOG_NORMAL, 1, TRUE},
    {"deposit", do_deposit, POS_STANDING, 0, LOG_NORMAL, 1, TRUE},
    ...
    {"consider", do_consider, POS_RESTING, 0, LOG_NORMAL, 1, TRUE},
...
/*    { "show",         do_show,        POS_DEAD,        0,  LOG_NORMAL, 1 , FALSE}, */
    ...
    {".", do_gossip, MIN_POS_GOS, 0, LOG_NORMAL, 0, TRUE},
    {CFG_GOS_NAME, do_gossip, MIN_POS_GOS, 0, LOG_NORMAL, 1, TRUE},
#ifdef USE_MUSIC
    {CFG_MUS_NAME, do_music, MIN_POS_MUS, 0, LOG_NORMAL, 1, FALSE},
#endif
#ifdef USE_GOCIAL
    {"gocial", do_gocial, MIN_POS_GOS, 0, LOG_NORMAL, 1, TRUE},
#endif
    ...
    {"reply", do_reply, MIN_POS_TELL, 0, LOG_NORMAL, 1, TRUE},
...
/*
    ...
    {"join", do_join, POS_RESTING, 0, LOG_NORMAL, 1, TRUE},
    {"petition", do_petition, POS_RESTING, 0, LOG_NORMAL, 1, TRUE},
    {"accept", do_accept, POS_RESTING, 0, LOG_NORMAL, 0, TRUE},
    {"decline", do_decline, POS_RESTING, 0, LOG_NORMAL, 0, TRUE},
    {"offer", do_offer, POS_RESTING, 0, LOG_NORMAL, 1, TRUE},
    {"clantalk", do_clantalk, POS_SLEEPING, 0, LOG_NORMAL, 1, TRUE},
    {"resign", do_resign, POS_SLEEPING, 0, LOG_NORMAL, 1, TRUE},
